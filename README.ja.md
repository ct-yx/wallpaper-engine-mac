...
- **パーティクルエフェクト** — 一般的な SpriteKit 互換エミッターに対応しています。高度なパーティクル演算子、ロープ／トレイルレンダラー、コントロールポイント、アニメーションスプライトシートは近似実装または未対応です。
...
- **アニメーションシーン** — シーン画像レイヤー上の TEXS マルチイメージ／アトラスアニメーションと `.tex-json` スプライトシートに対応しています。パーティクルのフレームアニメーションとタイムライン／スクリプト駆動のオブジェクトアニメーションは未対応です。
